/*
 *  MtkFlash - A command-line tool for flashing, reading, and formatting
 *  MediaTek (MTK) devices via serial/USB (preloader mode).
 *
 *  Copyright (C) 2023 Securely - Jean-Christophe Rona
 *
